...
<div align="center">
	<br><br>
	<img src="image//submitSign.png" style="width:100px;height:100px;">
	<br><br>
	<div><h1>${message }</h1></div>
	<br>
	<div class="button-group-area mt-40">
	<button type="button" id="goListBtn" class="genric-btn default circle" style="font-weight: bold;font-size: 15px;" onclick="location.href='exhibitList.do'">OK</button>
	</div>
</div>
</body>
</html>