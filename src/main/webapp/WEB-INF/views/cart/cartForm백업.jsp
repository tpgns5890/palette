...
<body>
			...
			<table class="cart" border="1">
				<tr>
					...
					<td width="100px" id="${cart.productNumber}" name="${cart.productNumber}">
						...
						<input type="text" value="${cart.productCount}" readonly style="width: 25px;">
	...
	<div class="foot" id="total" style="border: 1px solid black;">
		<input type="button" class="btn-open-popup" value="결제하기" onclick=fncPay()> <input
			type="button" value="선택삭제" id="del">
		<h3>총 금액</h3>
		<h4>
			<c:out value="${sum }" />
		</h4>
			...
			<h3>결제폼</h3>
				...
				<c:if test="${cart.productCount >0}">
					<table border="1">
						<tr height ="30px">
							<td width="100px">
								<img class="product-img-pay" src="/palette/image/${cart.getImage()}" alt="..." />
							</td>
							<td width="100px">
								${cart.productName}
							</td>
					...
					<table border="1">
						...
						<tr>
							...
							<td><input type="text" id="postcode" name="postcode"
								placeholder="우편번호" value="${fn:split((account.address),',')[0]}">
						...
						<tr>
							...
							<td><input type="text" id="address" name="address"
								...
								value="${fn:trim(fn:split((account.address),',')[1])}"></td>
						</tr>
						<tr>
							<th>detailAddress</th>
							<td><input type="text" id="detailAddress"
								name="detailAddress" placeholder="상세주소"
								value="${fn:trim(fn:split((account.address),',')[2])}"> <input
